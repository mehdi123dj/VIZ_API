...
class ControlPanel():
    ...
    def __call__(self, edge_legend, node_legend, data_edges, data_nodes):
        ...
        self.E = [html.Div(id={'class': 'edge_legend', 'index': edge_legend.index(elem), 'label': elem[1]},
            ...
            #dbc.Badge(elem[1],href="#",color=elem[0], pill=True, className="me-1 text-decoration-none")
    ...
    def create_CP(self):
            ...
            Returns:
                html.Div: Div object composed of two tabs:
                    ...
                    Export (dcc.Tab): A dcc.Tab object composed of three htlm.Button objects:
                        ...
                        btn-get-svg (htlm.Button): Button for launching the download of the  view as svg
        ...
        return html.Div([
            dcc.Tabs(id='tabs', children=[
                dcc.Tab(label='Legend',children=[
                        html.Div([
                            html.Div(
                                children=[
                                    html.Div(
                                        children=[
                                            html.B(children='Nodes Legend',style = {'color':'darkorchid','fontWeight':'bold'}),
                                            html.Div(id='nodes-legend',
                                                     children=self.N,
                                                     )
                                        ]
                                    )
                                ], style={'background-color': 'lightgrey', 'padding': '3%', 'margin': '4%','border-radius':'10px'}
                            ...
                            html.Div(
                                children=[
                                    html.Div(
                                        children=[
                                            html.B(children='Edges legend',style = {'color':'darkorchid','fontWeight':'bold'}),
                        ...
                        ],selected_style = self.styles["tab_selected_style"]),
                dcc.Tab(label='Element info', children=[
                        html.Div(
                            children=[
                                html.B(children='Element info',style = {'color':'darkorchid','fontWeight':'bold'}),
        ...
        style={'width': '20%','display': 'inline-block','verticalAlign': 'top','background-color': 'black',}
        #style={'width': '20%','position':'absolute','bottom':'0','height':'100%','margin':'0','top':'92.5px','display': 'inline-block','verticalAlign': 'top','background-color': 'black',}
    ...
    def get_callbacks(self, app):
        ...
        @app.callback(
            ...
            Input("dropdown-save", "value"),
            )
        def save_image(format_type):
            action = 'download'
            ftype = None
